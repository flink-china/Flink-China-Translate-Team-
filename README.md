...
- [Apache Flink Documentation](https://ci.apache.org/projects/flink/flink-docs-master/)：以1.6版本作为翻译蓝本，在Docs目录：
...
本翻译规范原文摘自[tuhaihe](https://github.com/tuhaihe)，也非常感谢下面技术社区对本翻译项目的支持（排名不分先后）：
